<template>
    ...
    <v-navigation-drawer
      ...
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="text-h6" v-text="this.$store.state.appNavTitle">
          </v-list-item-title>
          
          <v-list-item-subtitle v-text="this.$store.state.appsubNavTitle">
  ...
  data () {
      return {
        ...
        items: [
          ...
          { title: 'Button Icon', icon: 'mdi-alpha-b-circle', to:'/button-icon' },
